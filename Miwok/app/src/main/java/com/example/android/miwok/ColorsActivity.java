...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors.add(new Word("red","weteti",R.drawable.color_red,R.raw.color_red));
        ...
        colors.add(new Word("mustard yellow","chiwitti",R.drawable.color_mustard_yellow,R.raw.color_mustard_yellow));
